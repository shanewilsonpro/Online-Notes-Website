...
if(!$result){
    ...
    $message .= "http://shanewilson.host20.uk/Online-Notes-Website/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
    if(mail($newemail, 'Email Update for you Online Notes App', $message, 'From:'.'shanewilsonpro@gmail.com')) {
